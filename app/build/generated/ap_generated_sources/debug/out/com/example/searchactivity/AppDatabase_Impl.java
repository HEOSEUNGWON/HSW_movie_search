...
public final class AppDatabase_Impl extends AppDatabase {
  private volatile UserRepository _userRepository;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `SearchHistory` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `movieName` TEXT)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'bb5fbf822decdae9a125571b4f2ffff8')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsSearchHistory.put("movieName", new TableInfo.Column("movieName", "TEXT", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoSearchHistory.equals(_existingSearchHistory)) {
          return new RoomOpenHelper.ValidationResult(false, "SearchHistory(com.example.searchactivity.SearchHistory).\n"
                  + " Expected:\n" + _infoSearchHistory + "\n"
                  + " Found:\n" + _existingSearchHistory);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "bb5fbf822decdae9a125571b4f2ffff8", "ce6288624979ca24d4e02b8ba3ff2010");
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(UserRepository.class, UserRepository_Impl.getRequiredConverters());
  ...
  public UserRepository userRepository() {
    if (_userRepository != null) {
      ...
      synchronized(this) {
        if(_userRepository == null) {
          _userRepository = new UserRepository_Impl(this);
        }
        return _userRepository;
      }
    }
